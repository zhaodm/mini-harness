...
5. **保留历史**：code-report 保存为 `.engine/code-report-r{N}.md`（不覆盖上轮），记录本轮修复了什么

---

## 修复派发

1. 快照当前 deliverables/{project}/ 文件 hash，追加到 `.engine/.state.md` repair_snapshots
...
4. 写入新 handoff `.engine/handoffs/{project}-DEV1-T{N}-R{R+1}.md`，含修复上下文:
